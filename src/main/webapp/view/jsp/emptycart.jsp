...
<head>
    ...
    <title>Book Haven - Your Cart</title>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            background-image: url('${pageContext.request.contextPath}/view/books/oouch.webp');
...
<body>
    ...
    <div class="hero">
        <div class="hero-content">
            ...
            <a href="/shopbooks" class="cta-btn">Browse Books</a>
        </div>
    </div>
